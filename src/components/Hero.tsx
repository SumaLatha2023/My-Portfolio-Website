...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-pulse-slow" style={{
        animationDelay: "1s"
      }}></div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-48 right-20 glass p-3 rounded-lg animate-float opacity-50" style={{
        animationDelay: "1s"
      }}>
          <code className="text-xs text-primary">{"const dev = () => {}"}</code>
        </div>
        <div className="absolute bottom-32 left-32 glass p-3 rounded-lg animate-float opacity-50" style={{
        animationDelay: "2s"
      }}>
          <code className="text-xs text-accent">{"print('Hello')"}</code>
        </div>
        <div className="absolute bottom-48 right-32 glass p-3 rounded-lg animate-float opacity-50" style={{
        animationDelay: "0.5s"
      }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-6 animate-fadeInUp">
            <h2 className="text-xl text-foreground/80 mb-4 md:text-4xl">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-8 animate-fadeInUp" style={{
          animationDelay: "0.3s"
        }}>
          ...
          <div className="flex gap-6 justify-center animate-fadeInUp" style={{
          animationDelay: "0.6s"
        }}>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="glass p-3 rounded-full hover:bg-primary/20 transition-all duration-300 hover:scale-110">
              <Github className="h-6 w-6" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="glass p-3 rounded-full hover:bg-primary/20 transition-all duration-300 hover:scale-110">
