...
const Contact = () => {
  ...
  return <section id="contact" ref={sectionRef} className="min-h-screen flex items-center py-20 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className={`space-y-8 ${isVisible ? "animate-slideInLeft" : "opacity-0"}`}>
            ...
            <div className="flex gap-4">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="glass p-4 rounded-xl hover:bg-primary/10 transition-all hover:scale-110 mx-[40px]">
                <Github className="h-6 w-6" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="glass p-4 rounded-xl hover:bg-primary/10 transition-all hover:scale-110">
          ...
          {/* Contact Form */}
          <div className={`glass p-8 rounded-2xl ${isVisible ? "animate-slideInRight" : "opacity-0"}`}>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Tell me about your project or idea..." rows={5} value={formData.message} onChange={e => setFormData({
                ...formData,
                message: e.target.value
              })} className="bg-secondary/50 border-primary/30 focus:border-accent resize-none" />
              </div>

              <Button type="submit" className="w-full bg-gradient-to-r from-primary to-accent hover:opacity-90 glow">
